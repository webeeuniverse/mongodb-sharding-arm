...
install_mongo4() {
	...
	rpm -i mongodb-org-server-4.4.4-1.el7.x86_64.rpm
        rpm -i mongodb-org-shell-4.4.4-1.el7.x86_64.rpm
        rpm -i mongodb-org-mongos-4.4.4-1.el7.x86_64.rpm
...
GetMongoPackage "https://repo.mongodb.org/yum/redhat/7/mongodb-org/4.4/x86_64/RPMS/mongodb-org-server-4.4.4-1.el7.x86_64.rpm"
GetMongoPackage "https://repo.mongodb.org/yum/redhat/7/mongodb-org/4.4/x86_64/RPMS/mongodb-org-shell-4.4.4-1.el7.x86_64.rpm"
GetMongoPackage "https://repo.mongodb.org/yum/redhat/7/mongodb-org/4.4/x86_64/RPMS/mongodb-org-mongos-4.4.4-1.el7.x86_64.rpm"
install_mongo4

#start router server
mongos --configdb crepset/10.1.0.240:27019,10.1.0.241:27019,10.1.0.242:27019 --bind_ip 0.0.0.0 --port 27017 --logpath /var/log/mongodb/mongos.log --fork --keyFile /etc/mongokeyfile --sslMode requireSSL --sslPEMKeyFile /etc/MongoAuthCert.pem --sslPEMKeyPassword $mongoSslCertPswd
